...
DIRECT_SINKS: dict[str, tuple[SinkRow, ...]] = _rows(
    ...
    SinkRow(
        "requests.get",
        "NET",
        {"url.host": A(0, kw="url"), "url.query": KW("params"), "headers": KW("headers")},
    ...
    SinkRow(
        "requests.post",
        "NET",
        {"url.host": A(0, kw="url"), "body": HTTP_BODY, "headers": KW("headers")},
        required_by=("A16",),
    ),
    SinkRow("requests.put", "NET", {"url.host": A(0, kw="url"), "body": HTTP_BODY}),
    SinkRow("requests.patch", "NET", {"url.host": A(0, kw="url"), "body": HTTP_BODY}),
    SinkRow("requests.delete", "NET", {"url.host": A(0, kw="url")}),
    SinkRow("requests.head", "NET", {"url.host": A(0, kw="url")}),
    SinkRow("requests.request", "NET", {"url.host": A(1, kw="url"), "body": HTTP_BODY}),
    SinkRow("httpx.get", "NET", {"url.host": A(0, kw="url"), "url.query": KW("params")}),
    SinkRow("httpx.post", "NET", {"url.host": A(0, kw="url"), "body": HTTP_BODY}),
    SinkRow("httpx.request", "NET", {"url.host": A(1, kw="url"), "body": HTTP_BODY}),
    SinkRow("urllib.request.urlopen", "NET", {"url.host": A(0, kw="url")}),
    SinkRow("urllib.request.urlretrieve", "NET", {"url.host": A(0, kw="url")}),
    SinkRow(
...
PROXY_SINKS: tuple[ProxyRow, ...] = (
    ...
    ProxyRow(
        ...
        method="get",
        kind="NET",
        slots={"url.host": A(0, kw="url"), "url.query": KW("params"), "body": HTTP_BODY},
    ...
    ProxyRow(
        ...
        method="post",
        kind="NET",
        slots={"url.host": A(0, kw="url"), "body": HTTP_BODY},
        from_ctor={"url.scheme": "base_url"},
    ),
    ProxyRow(
        recv_types=("httpx.Client", "httpx.AsyncClient", "requests.Session"),
        method="request",
        kind="NET",
        slots={"url.host": A(1, kw="url"), "body": HTTP_BODY},
        from_ctor={"url.scheme": "base_url"},
    ),
    # paramiko
    ProxyRow(
