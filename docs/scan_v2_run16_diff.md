# full scan の突き合わせ: `scan_v2_run14` → `scan_v2_run16`

再現: `python scripts/compare_scans.py evidence/scan_v2_run14 evidence/scan_v2_run16`
...
| 項目 | scan_v2_run14 | scan_v2_run16 | 差 |
|---|---|---|---|
...
| `GAP_INJECT` の行 | 2810 | 1705 | -1105 |
| `GAP_SELECT` の行 | 522 | 492 | -30 |
| `UNKNOWN` の行 | 12156 | 9221 | -2935 |
...
| 主体 / root | scan_v2_run14 | scan_v2_run16 | 差 |
|---|---|---|---|
| `MODEL` / root あり | 4291 | 2298 | -1993 |
| `OP` / root なし | 10979 | 10615 | -364 |
| `OP` / root あり | 41 | 39 | -2 |

**「root はあるのに主体が OP」**（D44 が矛盾と呼んだ状態）: 41 → 39（-2）。
...
- `v2-vishalsachdev__canvas-mcp|mcp:register_peer_review_comment_tools.generate_peer_review_feedback_report:947e5bcba3be|register_peer_review_comment_tools.generate_peer_review_feedback_report|src/canvas_mcp/tools/peer_review_comments.py:328`: 50 → 20（-30）
