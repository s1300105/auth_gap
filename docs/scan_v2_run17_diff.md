# full scan の突き合わせ: `scan_v2_run16` → `scan_v2_run17`

再現: `python scripts/compare_scans.py evidence/scan_v2_run16 evidence/scan_v2_run17`
...
| 項目 | scan_v2_run16 | scan_v2_run17 | 差 |
|---|---|---|---|
...
| `GAP_INJECT` の行 | 1705 | 2020 | +315 |
| `GAP_SELECT` の行 | 492 | 496 | +4 |
| `UNKNOWN` の行 | 9221 | 10587 | +1366 |
...
| 主体 / root | scan_v2_run16 | scan_v2_run17 | 差 |
|---|---|---|---|
| `MODEL` / root あり | 2298 | 2616 | +318 |
| `OP` / root なし | 10615 | 10994 | +379 |
| `OP` / root あり | 39 | 39 | +0 |
