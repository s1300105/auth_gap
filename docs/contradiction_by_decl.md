...
再現: `python scripts/contradiction_by_decl.py evidence/scan_v2_run20`
...
|---|---|---|---|---|---|---|---|---|---|
| 採った原理（1-i b / 1-ii b / 2 a / 3 a / 4 a） | 109 | 95 | 44 | 109 | **153** | 39 | 100 | 0 | 72 |
| 1-i を a に（永続する設定を含めない） | 98 | 95 | 44 | 99 | **142** | 39 | 100 | 0 | 72 |
| 1-ii を a に（リモートの状態を含めない） | 109 | 45 | 36 | 50 | **145** | 39 | 100 | 0 | 72 |
| 2 を b に（不明を矛盾に倒す） | 204 | 0 | 153 | 0 | **357** | 139 | 0 | 72 | 0 |
| 2 を c に（不明を宣言内に倒す） | 109 | 0 | 44 | 0 | **153** | 39 | 0 | 0 | 0 |
| 3 を b に（モデル由来の値を能力として読まない） | 109 | 95 | 44 | 109 | **153** | 38 | 101 | 0 | 72 |
| 4 を b に（破壊性の 2 つだけ） | 109 | 95 | 44 | 109 | **153** | 0 | 0 | 0 | 0 |
