...
再現: `python scripts/contradiction_by_decl.py evidence/scan_v2_run15`
...
|---|---|---|---|---|---|---|---|---|---|
| 採った原理（1-i b / 1-ii b / 2 a / 3 a / 4 a） | 107 | 95 | 44 | 106 | **151** | 39 | 99 | 0 | 71 |
| 1-i を a に（永続する設定を含めない） | 96 | 95 | 44 | 96 | **140** | 39 | 99 | 0 | 71 |
| 1-ii を a に（リモートの状態を含めない） | 107 | 45 | 36 | 49 | **143** | 39 | 99 | 0 | 71 |
| 2 を b に（不明を矛盾に倒す） | 202 | 0 | 150 | 0 | **352** | 138 | 0 | 71 | 0 |
| 2 を c に（不明を宣言内に倒す） | 107 | 0 | 44 | 0 | **151** | 39 | 0 | 0 | 0 |
| 3 を b に（モデル由来の値を能力として読まない） | 107 | 95 | 44 | 106 | **151** | 38 | 100 | 0 | 71 |
| 4 を b に（破壊性の 2 つだけ） | 107 | 95 | 44 | 106 | **151** | 0 | 0 | 0 | 0 |
