...
再現: `python scripts/contradiction_by_decl.py evidence/scan_v2_run14`
...
|---|---|---|---|---|---|---|---|---|---|
| 採った原理（1-i b / 1-ii b / 2 a / 3 a / 4 a） | 109 | 91 | 45 | 105 | **154** | 38 | 96 | 0 | 71 |
| 1-i を a に（永続する設定を含めない） | 98 | 91 | 45 | 95 | **143** | 38 | 96 | 0 | 71 |
| 1-ii を a に（リモートの状態を含めない） | 109 | 42 | 37 | 48 | **146** | 38 | 96 | 0 | 71 |
| 2 を b に（不明を矛盾に倒す） | 200 | 0 | 150 | 0 | **350** | 134 | 0 | 71 | 0 |
| 2 を c に（不明を宣言内に倒す） | 109 | 0 | 45 | 0 | **154** | 38 | 0 | 0 | 0 |
| 3 を b に（モデル由来の値を能力として読まない） | 109 | 91 | 45 | 105 | **154** | 37 | 97 | 0 | 71 |
| 4 を b に（破壊性の 2 つだけ） | 109 | 91 | 45 | 105 | **154** | 0 | 0 | 0 | 0 |
