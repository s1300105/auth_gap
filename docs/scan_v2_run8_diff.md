# full scan の突き合わせ: `scan_v2_run7` → `scan_v2_run8`

再現: `python scripts/compare_scans.py evidence/scan_v2_run7 evidence/scan_v2_run8`
...
| 項目 | scan_v2_run7 | scan_v2_run8 | 差 |
|---|---|---|---|
...
| 主体 / root | scan_v2_run7 | scan_v2_run8 | 差 |
|---|---|---|---|
