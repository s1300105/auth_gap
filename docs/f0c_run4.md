...
| 条件 | 測定量 | 値 |
|---|---|---|
| (iii) ツール本体が別プロセス / HTTP の向こうにある率 | `resolution.remote` [app] | 0.0% |
| (iii) ツール本体が別プロセス / HTTP の向こうにある率 | `resolution.remote` [mcp_server] | 0.0% |
| (iii) ツール本体が別プロセス / HTTP の向こうにある率 | `resolution.remote` [tool_package] | 0.0% |
| (iv) 無ガードのシェル実行が仕様である率 | `rubric1c` [app] | 1/3 = 33.3% |
| (iv) 無ガードのシェル実行が仕様である率 | `rubric1c` [mcp_server] | 2/3 = 66.7% |
| (iv) 無ガードのシェル実行が仕様である率 | `rubric1c` [tool_package] | 0/0 = — |
